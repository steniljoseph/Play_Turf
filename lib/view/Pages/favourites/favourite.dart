...
import 'package:play_turf/View/Pages/favourites/custom_fav.dart';
              ...
              child: Obx(
                () => ListView.separated(
                  ...
                  itemBuilder: (context, index) => CustomFavourite(
                    image: fc.favList[0].turf[index].turfDetails[0].turfPictures[0],
                    turfName: fc.favList[0].turf[index].turfDetails[0].centername,
                    location: "location",
                    category: "category",
                    price: "price",
                    remove: () {},
